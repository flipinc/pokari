...
class CharParser:
    ...
    def __init__(
        ...
        Args:
            ...
            ignore_id: Index to filter out from final list of tokens
                (default: -1).
    ...
    def _tokenize(self, text: str) -> List[int]:
        ...
        # If unk_id == ignore_id, OOV tokens are removed.
        tokens = [token for token in tokens if token != self._ignore_id]
...
class ENCharParser(CharParser):
    ...
    PUNCTUATION_TO_REPLACE = frozendict({"+": "plus", "&": "and", "%": "percent"})
...
def make_parser(
    ...
    **kwargs,
    ...
    Examples:
        ...
        ENCharParser
    """
    parsers = {"base": CharParser, "en": ENCharParser}
